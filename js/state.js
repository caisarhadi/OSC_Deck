const createCamState = () => ({ tx: 0, ty: 0, rx: 0, ry: 0, rz: 0, k1: 0.5, k2: 0, k3: 0, k4: 0, k5: 1, k6: 1, slider: 0, sliderV: 0, sliderV2: 0.5, sliderV3: 0.5, afOn: false, resetOn: false, resetFcs: false, resetIris: false, resetFcl: false, resetShutter: false, resetEi: false, resetNd: false, resetWb: false });
...
export const KNOB_CONFIGS = [
    ...
    { key: 'k4', label: 'WB', zeroToOne: false, resetKey: 'resetWb' },
    { key: 'k5', label: 'T-RATE', zeroToOne: true },
    { key: 'k6', label: 'MASTER RATE', zeroToOne: true }
];

export const SLIDER_V_CONFIGS = [
    { key: 'sliderV', label: 'FCS', zeroToOne: false, resetKey: 'resetFcs' },
